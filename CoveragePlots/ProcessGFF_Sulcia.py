...
## Assign Sulcia genes to broad functional categories.
Genes = {'rplB': 'riboprot', 'rplC': 'riboprot', 'rplD': 'riboprot', 'rplE': 'riboprot',
         ...
         'rsmA': 'riboprot', 'rsmH': 'riboprot', 'rsmI': 'riboprot', 'ilvB': 'biosynth', 'ilvN': 'biosynth',
         'ilvC': 'biosynth', 'ilvD': 'biosynth', 'ilvE': 'biosynth', 'leuA': 'biosynth', 'leuC': 'biosynth',
         'leuD': 'biosynth', 'leuB': 'biosynth', 'lysC': 'biosynth', 'asd': 'biosynth', 'thrA': 'biosynth', 
         'thrB': 'biosynth', 'groS' : 'chaperone', 'groL' : 'chaperone', 'dnaJ' : 'chaperone', 'dnaK' : 'chaperone', 
         'thrC': 'biosynth', 'ilvA':'biosynth', 'dapA':'biosynth', 'dapB':'biosynth', 'dapD':'biosynth',
         'argD':'biosynth', 'dapE':'biosynth', 'dapF':'biosynth', 'lysA': 'biosynth', 'argA': 'biosynth', 
         'argB':'biosynth', 'argC':'biosynth', 'argE':'biosynth', 'argF': 'biosynth', 'argG': 'biosynth', 
         'argH':'biosynth', 'carA':'biosynth', 'carB':'biosynth', 'aroG': 'biosynth', 'aroB': 'biosynth', 
         'aroD':'biosynth', 'aroE':'biosynth', 'aroK':'biosynth', 'aroA': 'biosynth', 'aroC': 'biosynth', 
         'pheA':'biosynth', 'aspC':'biosynth', 'trpD':'biosynth', 'trpE': 'biosynth', 'trpG': 'biosynth',
         'trpF':'biosynth', 'trpC':'biosynth', 'trpA':'biosynth', 'trpB': 'biosynth', 'rpsO' : 'riboprot', 
         'rpsQ1': 'riboprot', 'rpsT': 'riboprot', 'rpsU': 'riboprot', 'rpmE2': 'riboprot', 'rpmH': 'riboprot', 
         'rplA': 'riboprot', 'rplI': 'riboprot', 'rplR': 'riboprot'
         }
